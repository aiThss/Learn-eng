...
<p justify="center">
  <a href="https://raw.githubusercontent.com/aiThss/Learn-eng/main/releases/EnglishUp-v0.1.4.apk">
    <img src="https://img.shields.io/badge/📥%20Download-Android%20APK%20v0.1.4-brightgreen.svg?style=for-the-badge&logo=android&logoColor=white" alt="Download APK" />
  </a>
  <a href="https://github.com/aiThss/Learn-eng/tree/main/releases">
    <img src="https://img.shields.io/badge/Version-v0.1.4-blue.svg?style=for-the-badge" alt="Version v0.1.4" />
  </a>
...
👉 [**📥 Tải EnglishUp v0.1.4 APK**](https://raw.githubusercontent.com/aiThss/Learn-eng/main/releases/EnglishUp-v0.1.4.apk)
...
SHA-256 của `EnglishUp-v0.1.4.apk`: `A7F348A026FD69536B264C40DB47C039CCC9A788764A75B5F40E5681EE089C2C`

### 🛠️ Hướng dẫn cài đặt trên Android:
1. Nhấn đường link trên để tải file `EnglishUp-v0.1.4.apk`.
